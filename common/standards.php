...
l'article de Wikipedia</a> à ce sujet. Pour résumer, ce sont un ensemble de normes destinées à fournir
une manière commune d'organiser des données sur le web
(<a class="wikipedia" href="http://fr.wikipedia.org/wiki/Hypertext_Markup_Language">(X)HTML)</a>,
de les présenter (<a class="wikipedia" href="http://fr.wikipedia.org/wiki/Cascading_Style_Sheet">CSS</a>),
de les décrire (<a class="wikipedia" href="http://fr.wikipedia.org/wiki/Extensible_Markup_Language">XML</a>), de les 
actualiser (<a class="wikipedia" href="http://fr.wikipedia.org/wiki/Atom">Atom</a>), mais aussi de décrire des images 
...
<p>
Toute cette théorie technique est à l'&#156;uvre dans le logiciel qui permet d'afficher les pages web,

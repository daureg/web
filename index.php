...
<a href="/common/standards.php#navigateur" class="intern">navigateur</a>).</li>
...
<li>Ecriture de la page sur <a class="intern" href="common/standards.php">les standards du web</a>.</li>
...
<li>Pour mes dossiers de l'année prochaine, j'ai du rédiger un <a class="intern" href="about/cv.png">cv</a>, si vous avez envie de rigoler.</li>
